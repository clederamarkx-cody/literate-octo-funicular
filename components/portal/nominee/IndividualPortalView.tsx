...
import { User, MapPin, Briefcase, Hash, HardHat, Unlock, Lock, ChevronDown, Send } from 'lucide-react';
                        ...
                        <div className="flex flex-col md:flex-row justify-between gap-10">
                            <div className="flex-1 space-y-8">
                                ...
                                <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                                    <div className="space-y-2"><span className="text-[10px] font-bold text-gray-400 uppercase block">Category</span><div className="flex items-center gap-2 text-sm font-bold text-gkk-navy"><Briefcase size={16} className="text-gkk-gold" /> {nomineeData?.details?.nomineeCategory}</div></div>
                                    ...
                                    <div className="space-y-2"><span className="text-[10px] font-bold text-gray-400 uppercase block">Professional Role</span><div className="flex items-center gap-2 text-sm font-bold text-gkk-navy"><HardHat size={16} className="text-gkk-gold" /> {nomineeData?.details?.safetyOfficer}</div></div>
